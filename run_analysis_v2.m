...
%% 
data_proc_corsi = extractSingleJIDFromTestTime(taps_tests, "corsi", 1000);
data_proc_2back = extractSingleJIDFromTestTime(taps_tests, "2back", 1000);
% data_proc_rtime = extractSingleJIDFromTestTime(taps_tests, "rtime", 1000);
data_proc_switch = extractSingleJIDFromTestTime(taps_tests, "taskswitch", 1000);
