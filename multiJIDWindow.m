...
all_data_proc = cell2table(cell(0, 7), 'VariableNames', {'partId', 'jids', 'n_taps', 'age', 'gender', 'entropy', 'usage'});
...
%     age = data_{1, 'age'};
    ...
    for this_win = 1:n_win
        ...
        if length(cell2mat(win_taps.taps)) >= 100
            ...
            this_age = int32(years(last_tap - birthdate));
            all_jids = cat(3, all_jids, this_jid);
            all_n_taps = [all_n_taps, this_n_taps];
            all_ages = [all_ages, this_age];
